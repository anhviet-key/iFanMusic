...
window.onscroll = () => {
  if (
    document.documentElement.scrollTop >= 433.8461608886719 ||
    document.body.scrollTop >= 433.8461608886719
  ) {
    bars.style.cssText =
      "margin-top: 0;background-color: #200c3b;box-shadow: 0px 5px 15px;position: fixed;padding:0;width: 100%;top: 0;left: 0;right: 0;";
  } else {
    bars.style = "none";
  }
};
...
overlays.onclick = function () {
  sets.classList.remove("blocks");
};
set1.onclick = function () {
  setslist.style.transform = "translateX(0)";
};
exit.onclick = function () {
  setslist.style.transform = "translateX(-100%)";
};
